...
var pizzaSources = ["margeritha.png","hawaii.png","salami.png","funghi.png","quattro_formaggi.png"];
var base = 0;
var pizzaCount = 0;
var discount = false;
var ordered = false;
...
for (var i = 0; i < pizzaSources.length; i++) {

  var img = document.createElement("img");
  img.src = pizzaSources[i];
 // img.setAttribute("src", pizzaSources[i]);;
  img.setAttribute("id", "img"+ i);
  document.getElementById("displayPizza").appendChild(img);
